...
const categories = [
    { key: 'greetings', name: '日常问候类', comment: '日常问候类' },
    { key: 'emotions', name: '情感表达', comment: '情感表达类' },
    { key: 'numbers', name: '数字', comment: '数字类' },
    { key: 'colors', name: '颜色', comment: '颜色类' },
    { key: 'family', name: '家人称呼', comment: '家人称呼类' },
    { key: 'time', name: '时间常用', comment: '时间常用类' },
    { key: 'food', name: '食物基础', comment: '食物基础类' },
    { key: 'sentences', name: '常用语句', comment: '常用语句类' },
    { key: 'conversations', name: '交流对话', comment: '交流对话类' }
];
